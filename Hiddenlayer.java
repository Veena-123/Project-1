...
public class HiddenLayer extends Layer {
	...
	public ArrayList<HiddenLayer>initLayer(HiddenLayerhiddenLayer,
			ArrayList<HiddenLayer>listOfHiddenLayer, InputLayerinputLayer,
			OutputLayeroutputLayer) {
	...
	public void printLayer(ArrayList<HiddenLayer>listOfHiddenLayer) {
		if (listOfHiddenLayer.size() > 0) {
			...
			int h = 1;
			for (HiddenLayerhiddenLayer :listOfHiddenLayer) {
